...
public class CreateTable {
    ...
    static SplashScreen1 dialog = new SplashScreen1();
    ...
    public static void createDatabase(String DBpath){
        ...
        JOptionPane.showMessageDialog(null , "Wait for database creating...", "Database Creating", JOptionPane.INFORMATION_MESSAGE);
        ...
        try{
            if(connection == null || connection.isClosed()){
                ...
                try {
                    FileReader reader = new FileReader(new File(path+"\\db.sql"));
